...
export default function BioStackSection({ telegramLink }: BioStackSectionProps) {
            ...
            <div className="relative group">
                ...
                <div className="relative h-full bg-[#0d0d0d] border border-gray-800 group-hover:border-neon-platinum/50 rounded-2xl p-8 backdrop-blur-sm transition-colors">
                    ...
                    <div className="flex flex-col gap-3 text-sm border-t border-gray-800 pt-6">
                        ...
                        <a href={telegramLink} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-gray-400 hover:text-[#0088cc] transition-colors p-2 hover:bg-white/5 rounded-lg">
