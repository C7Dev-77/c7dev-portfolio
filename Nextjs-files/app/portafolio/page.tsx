        ...
        {proyectos && proyectos.length > 0 && (
          <div className="mt-20 text-center">
            <div className="glass-panel inline-flex flex-col items-center p-8 rounded-2xl">
              ...
              <a
                href="https://t.me/+573244259132?text=Hola,%20me%20interesan%20tus%20proyectos,%20quisiera%20m%C3%A1s%20informaci%C3%B3n."
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-[#0088cc] to-[#005580] text-white font-bold uppercase tracking-wider rounded-xl hover:shadow-[0_0_20px_rgba(0,136,204,0.4)] transition-all"
              >
