          ...
          <div>
            ...
            <div className="flex gap-3 flex-wrap justify-center md:justify-start">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 border border-gray-700 rounded bg-black/50 flex items-center justify-center text-gray-400 hover:border-[#0088cc] hover:text-[#0088cc] hover:-translate-y-1 transition-all duration-300"
                title="Telegram"
              >
            ...
            <div className="mt-8 space-y-2">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-sm text-gray-300 hover:text-[#0088cc] transition-colors flex items-center gap-2"
              >
                <Send className="w-4 h-4 text-[#0088cc]" />
                Telegram: +57 324 425 9132
              </a>
            </div>
          </div>
        </div>
