...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'Por supuesto. Ofrezco una videollamada de 30 minutos completamente gratis para entender tu proyecto, resolver dudas y darte un presupuesto claro sin compromisos. Contáctame por Telegram o email.',
    category: 'Proceso',
  },
  {
    id: 6,
    ...
    answer:
      'Sí, trabajo con clientes de toda Latinoamérica y también de España, EE.UU. y otros países. La comunicación es 100% remota vía Telegram, Slack o Meet. Los pagos internacionales se manejan según convenga a ambas partes.',
